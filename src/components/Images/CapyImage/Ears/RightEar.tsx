...
import { DefaultRightEar, DefaultRightEarProps } from './Right/DefaultRightEar.js';
import { MischievousRightEar, MischievousRightEarProps } from './Right/MichievousRightEar.js';
