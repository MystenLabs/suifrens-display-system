...
type RightLegProps = SVGProps<SVGPathElement>;

export function RightLeg(props: RightLegProps) {
	return (
		<g transform="matrix(2.9166107177734375, 0, 0, 2.9166107177734375, 1463.45,1961.9)">
			<g transform="matrix(1, 0, 0, 1, 0, 0)">
				<path
					{...props}
					d="M6,171.3c-0.5,6.9-0.5,13.1-0.1,18.6c2.6,12.2,6.7,22.6,12.1,31.2c5.5,8.6,11.4,12.6,17.6,11.8
					c6.3-0.7,12.6-4.2,18.9-10.5c6.2-6.3,11.5-13.7,15.8-22.4c0.7-1.3,1.3-2.6,1.9-3.9c3.8-8.9,6.7-17.2,8.7-24.7
					c3.3-18,5.3-35.2,6.1-51.5c0.2-5.5,0.3-9,0.3-10.5l-73.1-5C14.5,121.4,11.8,143.8,6,171.3z"
				/>
				<path
					d="M34.3,238.1c-7.5,0-14.3-4.8-20.3-14.2C8.2,214.8,3.9,203.7,1.1,191c0-0.2-0.1-0.4-0.1-0.6c-0.5-5.7-0.5-12.3,0-19.4
