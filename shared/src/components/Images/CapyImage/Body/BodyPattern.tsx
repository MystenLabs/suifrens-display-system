...
import { BasicBodyPattern } from './Patterns/BasicBodyPattern';
import { CheetahBodyPattern } from './Patterns/CheetahBodyPattern';
import { DalmationBodyPattern } from './Patterns/DalmationBodyPattern';
import { FoxBodyPattern } from './Patterns/FoxBodyPattern';
import { LizardBodyPattern } from './Patterns/LizardBodyPattern';
import { PandaBodyPattern } from './Patterns/PandaBodyPattern';
import { SnakeBodyPattern } from './Patterns/SnakeBodyPattern';
import { StripesBodyPattern } from './Patterns/StripesBodyPattern';

type BodyPatternProps = {
	skin: CapySkin;
} & SVGProps<SVGGElement>;

const bodyPatternComponents: Record<CapySkin, ComponentType> = {
