...
import { type CapySkin } from '../../../../types/capyTypes';
import { BasicHeadPattern } from './Patterns/BasicHeadPattern';
import { CheetahHeadPattern } from './Patterns/CheetahHeadPattern';
import { DalmationHeadPattern } from './Patterns/DalmationHeadPattern';
import { FoxHeadPattern } from './Patterns/FoxHeadPattern';
import { LizardHeadPattern } from './Patterns/LizardHeadPattern';
import { PandaHeadPattern } from './Patterns/PandaHeadPattern';
import { SnakeHeadPattern } from './Patterns/SnakeHeadPattern';
import { StripesHeadPattern } from './Patterns/StripesHeadPattern';
...
export function HeadPattern({ skin, noseProps, ...headPatternProps }: HeadPatternProps) {
