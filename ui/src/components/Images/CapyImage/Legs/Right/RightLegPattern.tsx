...
import { DalmationRightLegPattern } from './Patterns/DalmationRightLegPattern';
import { SnakeRightLegPattern } from './Patterns/SnakeRightLegPattern';

type RightLegPatternProps = {
	skin: CapySkin;
} & SVGProps<SVGGElement>;

const rightLegPatternComponents: Record<CapySkin, ComponentType | null> = {
	basic: null,
	cheetah: null,
	fox: null,
	panda: null,
	...
	return (
		<g transform="matrix(2.9166107177734375, 0, 0, 2.9166107177734375, 1463.45,1961.9)">
			<g transform="matrix( 1, 0, 0, 1, 0,0) ">
				...
				<path
					d="M80.8,240H37.6C26,240,16,236.4,7.8,229.4c-8.5-7-12.8-15.8-12.8-26.2c0-3.2,0.4-6.3,1.2-9.3c1.8-7.9,3.5-15.6,4.9-23.2
